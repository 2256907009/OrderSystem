...
import com.example.spritgdemo1.pojo.ExpressRequest;
...
@RestController
public class KdApiExpressSearchDemo {

    //用户ID，快递鸟提供，注意保管，不要泄漏
    private String EBusinessID="1847940";//即用户ID，登录快递鸟官网会员中心获取 https://www.kdniao.com/UserCenter/v4/UserHome.aspx
    //API key，快递鸟提供，注意保管，不要泄漏
    private String ApiKey="25195f08-39e2-422b-923b-99a54938bb31";//即API key，登录快递鸟官网会员中心获取 https://www.kdniao.com/UserCenter/v4/UserHome.aspx
    //请求url, 正式环境地址
    private String ReqURL="https://api.kdniao.com/Ebusiness/EbusinessOrderHandle.aspx";

    @PostMapping("/express/search")
    public ResponseEntity<String> expressSearch(@RequestBody ExpressRequest expressRequest) {
        try {
            String logisticCode = expressRequest.getLogisticCode();
            String result = orderOnlineByJson(logisticCode);
